...
export default function BrandingPage() {
  return (
    <main>
        ...
        <Container>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Wir entwickeln <strong>Markenidentitäten</strong>, die strukturell durchdacht und visuell konsistent sind. Corporate Design verstehen wir als System – nicht als Dekoration.
            </p>
            <p style={{
              fontFamily: "var(--font-sans)",
              fontSize: "clamp(1rem, 1.8vw, 1.125rem)",
              ...
              Von der <strong>strategischen Positionierung</strong> bis zur <strong>visuellen Ausgestaltung</strong> entsteht eine klare Markenarchitektur, die langfristig tragfähig ist.
            </p>
          </div>
      ...
      {/* Projects Slider - Filtered by Branding tag */}
      <section style={{ paddingBottom: "clamp(60px, 8vw, 100px)" }}>
        <ProjectsSlider filterTags={["branding"]} />
      </section>
    </main>
  );
}
